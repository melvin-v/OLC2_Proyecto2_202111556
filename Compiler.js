import { FrameVisitor } from "./tools/Frame.js";
import  ReferenceVariable  from "./nodes/ReferenceVariable.js"
import { registers as r, floatRegisters as f } from "./tools/registers.js";
...
export default class Compiler extends Visitor {
    ...
    visitCall(node) {
        if (!(node.callee instanceof ReferenceVariable)) return
