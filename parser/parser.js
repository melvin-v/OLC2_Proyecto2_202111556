...
function peg$parse(input, options) {
  ...
  var peg$f5 = function(id, exp) { return new Declaration(id, exp, location()) };
  var peg$f6 = function(id, params, tipo) { return tipo };
  var peg$f7 = function(id, params, tipo, bloque) { return new FuncDcl(id, params || [], bloque, tipo, location()) };
  ...
  var peg$f12 = function(id, tipo) { return new Param(id, tipo, location()) };
  var peg$f13 = function(exp) { return new Print(exp, location()) };
  var peg$f14 = function(Bloque) { return Bloque };
  var peg$f15 = function(cond, stmtTrue, stmtFalse) { return stmtFalse };
  var peg$f16 = function(cond, stmtTrue, stmtFalse) { return new If(cond, stmtTrue, stmtFalse, location()) };
  var peg$f17 = function(cond, stmt) { return new While(cond, stmt, location()) };
  var peg$f18 = function(init, cond, inc, stmt) {
      return new For(init, cond, inc, stmt, location())
    };
  var peg$f19 = function() { return new Break(location()) };
  var peg$f20 = function() { return new Continue(location()) };
  var peg$f21 = function(exp) { return new Return(exp, location()) };
  var peg$f22 = function(exp) { return new ExpressionStmt(exp, location()) };
  var peg$f23 = function(head, tail) {
      return [head, ...tail.map(([_, __,___, exp]) => exp)];
  };
  var peg$f24 = function(dcls) { return new Block(dcls, location()) };
  ...
  var peg$f29 = function(asignado, asgn) { return new Assignment(asignado, asgn, location())};
  ...
  var peg$f40 = function(objetivoInicial, args) { return {args, tipo: 'funcCall' } };
  var peg$f41 = function(objetivoInicial, id) { return { id, tipo: 'get' } };
  var peg$f42 = function(objetivoInicial, operaciones) {
...
return op
  ...
  var peg$f45 = function() {return new Primitive(parseFloat(text(), 10), 'float', location()) };
  var peg$f46 = function() {return new Primitive(parseInt(text(), 10), 'int', location()) };
  var peg$f47 = function(texto) { return new Primitive(texto.join(''), 'string', location()) };
  var peg$f48 = function() { return new Primitive(true, 'boolean', location()) };
  var peg$f49 = function() { return new Primitive(false, 'boolean', location()) };
  var peg$f50 = function(exp) { return new Agrupation(exp, location()) };
  var peg$f51 = function(id) { return new ReferenceVariable(id, location()) };
