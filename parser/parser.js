...
function peg$parse(input, options) {
  ...
  var peg$f12 = function(exp) { return new Print(exp, location()) };
  var peg$f13 = function(Bloque) { return Bloque };
  var peg$f14 = function(cond, stmtTrue, stmtFalse) { return stmtFalse };
  var peg$f15 = function(cond, stmtTrue, stmtFalse) { return new If(cond, stmtTrue, stmtFalse, location()) };
  ...
  var peg$f21 = function(exp) { return new ExpressionStmt(exp, location()) };
...
return op
  ...
  var peg$f50 = function() {return new Primitive(parseInt(text(), 10), t.INT, location())};
  var peg$f51 = function(texto) { return new Primitive(texto.join(''), t.STRING, location()) };
  var peg$f52 = function() { return new Primitive(true, t.BOOLEAN, location()) };
  var peg$f53 = function() { return new Primitive(false, t.BOOLEAN, location()) };
  var peg$f54 = function(exp) { return new Agrupation(exp, location()) };
  var peg$f55 = function(id, args) { return crearNodo('instancia', { id, args: args || [] }) };
  var peg$f56 = function(id) { return new ReferenceVariable(id, location()) };
